...
if (isset($message) && is_array($message) && count($message) > 0) {
    echo '<div class="error-message">' . implode('<br>', $message) . '</div>';
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (enteredCaptcha !== actualCaptcha) {
            ...
            displayErrorMessage("CAPTCHA code is incorrect. Please try again.");
        }
    });
    ...
    function displayErrorMessage(message) {
        ...
        form.insertBefore(errorDiv, captchaInput.nextSibling);
    }
});
</script>
</body>
